...
// Temp directory for database restore uploads
const restoreUploadDir = path.resolve(__dirname, '../data/temp_restore');
...
export const restoreUpload = multer({
  ...
  limits: {
    fileSize: 100 * 1024 * 1024 // 100MB max for database file
  }
});
